...
class Table extends \Nette\Application\UI\Control
{
     ...
     */
    public function __construct($tableList, \Dibi\Connection $database, \BaseLanguageService $language, \AbstractTranslator $translator, \Nette\Caching\IStorage $storage)
    {
        parent::__construct();
        ...
        $this->cache = new \Nette\Caching\Cache($storage, 'cache' . __CLASS__);
